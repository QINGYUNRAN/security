...
# refer to https://github.com/aelder202/E-Guard/blob/main/Linux/no_gui_linux.py
import shlex
import subprocess
        ...
        for opt, arg in arguments:
            if opt in ("-h", "--help"):
                ...
                if program_path:
                    ...
                    with open(
                        os.path.join(autostart_path, "E-Guard.desktop"), "w"
                    ) as file1:
                        toFile = (
                            "[Desktop Entry]\n"
                            "Version=v0.1\n"
                ...
                if program_path:
                    ...
                    program_path = exists(
                        os.path.join(autostart_path, "E-Guard.desktop")
                    )
                    if not program_path:
